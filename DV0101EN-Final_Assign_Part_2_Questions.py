...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,
                                            ...
                                            labels={'Automobile_Sales': 'Average Sales'}  # Optional: Customize the y-axis label
                                ))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
                            figure=px.bar(
                                        ...
                                        labels={'Automobile_Sales': 'Total Sales', 'Unemployment_Rate': 'Unemployment Rate'},
                                        ))
...
if __name__ == '__main__':
    ...
    #app.run_server(port=8052)  # Change to a different port, e.g., 8051
